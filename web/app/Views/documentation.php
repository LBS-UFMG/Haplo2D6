...
<div class="container col-xxl-10 px-2 py-0">
    ...
    <ul class="text-muted mb-5">
        ...
        <li>Haplotype #1: Haplotype 1 (Haplotype)
        </li>
        <li>Allele Functional #1: Enzymatic activity for haplotype 1 (Enzymatic activity)
        </li>
        <li>Allele #1: Star allele for haplotype 1 (Star allele)
        </li>
        <li>Activity Value #1: Activity score for haplotype 1 (Activity score)
        </li>
        <li>Haplotype #2: Haplotype 2 (Haplotype)
        </li>
        <li>Allele Functional #2: Enzymatic activity for haplotype 2 (Enzymatic activity)
        </li>
        <li>Allele #2: Star allele for haplotype 2 (Star allele)
        </li>
        <li>Activity Value #2: Activity score for haplotype 2 (Activity score)
        </li>
        <li>Activity Score: Final score of the two haplotypes that give the activity score (Final score)
        </li>
        <li>Phenotype: Predicted phenotype of the individual
        </li>
        <li>Diplotype: refers to the combination of two haplotypes (represented by star alleles).</li>
    </ul>
